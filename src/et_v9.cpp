...
// Title: TSort
// Version: v9
// Details: (DBMA) Batching (double) + Multi-threading + sampling + asyn
// Author: Zheng Ying
// Comment: 
//
////////////////////////////////////////////
...
void et_v9(uint32_t num, uint32_t treeNum, uint32_t batchSize, uint32_t threadNum1, 
    ...
    Buffer* buffer = new Buffer[treeNum];
